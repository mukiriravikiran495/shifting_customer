...
public class MyBookingsDTO {
	...
	public MyBookingsDTO(long booking_id, String status, LocalDateTime bOOKING_DATE, String sCHEDULED_DATE,
	...
	public String toString() {
		return "MyBookingsDTO [booking_id=" + booking_id + ", status=" + status + ", BOOKING_DATE=" + BOOKING_DATE
