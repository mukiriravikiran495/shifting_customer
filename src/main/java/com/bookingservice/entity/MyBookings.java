...
public class MyBookings implements Serializable{
	...
	public String toString() {
		return "MyBookings [booking_id=" + booking_id + ", status=" + status + ", BOOKING_DATE=" + BOOKING_DATE
	...
	public MyBookings(long booking_id, String status, LocalDateTime bOOKING_DATE, String sCHEDULED_DATE,
